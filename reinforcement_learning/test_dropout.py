...
parser.add_argument('--verbose', action='store_true') # TODO: true by default...
...
for seed in range(num_seeds):
    ...
    for nq, query_fn in enumerate(query_fns):
        ...
        if args.resume:
            ...
            policy = Policy()
            reward_predictor = RewardPredictor(dropout=args.dropout)
        ...
        for episode in range(num_episodes):
            ...
            for step in range(num_steps):
                ...
                if args.render:
                    if step == 0:
                        # make dropout-free predictions! (TODO: ALL THE TIME!)
